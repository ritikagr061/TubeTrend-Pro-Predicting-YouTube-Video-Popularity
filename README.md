...
> Ritik Agrawal 19104024\
> Ankit Kumar 19103031
>
> **Under the guidance of**\
> Dr. Archana Purwar\
> Assistant Professor (Senior Grade)

![](vertopal_8c068c6a3dce4498a512cd7c33780b3a/media/image1.png){width="1.2819444444444446in"
...
|                       | > Introduction        |                       |
+-----------------------+-----------------------+-----------------------+
| **Chapter-2**         | > 1.2 Problem         | 1                     |
|                       | > Statement           |                       |
+-----------------------+-----------------------+-----------------------+
|                       | > 1.3 Significance of | 1                     |
|                       | > the problem         |                       |
+-----------------------+-----------------------+-----------------------+
|                       | > 1.4 Brief           | 2                     |
|                       | > Description of the  |                       |
...
|                       | > Details**           |                       |
+-----------------------+-----------------------+-----------------------+
| **Chapter-5**         | > 4.1 Design Diagrams | 28                    |
+-----------------------+-----------------------+-----------------------+
|                       | > 4.1.1 Control Flow  | 28                    |
|                       | > Diagram             |                       |
+-----------------------+-----------------------+-----------------------+
|                       | > 4.2 Implementation  | 29                    |
|                       | > Details and issues  |                       |
+-----------------------+-----------------------+-----------------------+
|                       | > 4.3 Risk Analysis   | 38                    |
|                       | > and Mitigation      |                       |
+-----------------------+-----------------------+-----------------------+
|                       | > **Testing (Focus on |                       |
|                       | > Quality of          |                       |
...
or other institute of high learning, except where due acknowledgment has
been made in the text.

+-----------------------+-----------------------+-----------------------+
| Place: Noida          | Signature:            | > Abhishek Pratap     |
|                       |                       | > Singh               |
+=======================+=======================+=======================+
| Date: 1st May 2023    | Name:                 |                       |
+-----------------------+-----------------------+-----------------------+
|                       | Enrollment No.        | > 19104019            |
+-----------------------+-----------------------+-----------------------+

> Signature:\
> Name: Ritik Agrawal\
> Enrollment No. 19104024
>
> Signature:\
> Name: Ankit Kumar\
> Enrollment No. 19103031
...
This is to certify that the work titled **\"Predicting YouTube Video
Views using Machine Learning Techniques"** submitted by **Abhishek
Pratap Singh (19104019), Ritik Agrawal (19104024), Ankit Kumar
(19103031)** in partial fulfillment for the award of degree of Bachelor
of Technology of Jaypee Institute of Information Technology, Noida has
been carried out under my supervision. This work has not been submitted
partially or wholly to any other University or Institute for the award
of this or any other degree or diploma.

Signature of Supervisor:\
Name of Supervisor: Dr. Archana Purwar\
Designation: Assistant Professor (Senior Grade) Date: 1st May 2023
...
I would like to express my gratitude to my supervisor, Dr. Archana
Purwar for her invaluable advice, guidance and her enormous patience
throughout the development of the research. In addition, I would also
like to express my gratitude to my loving family who had helped and
given me encouragement, support and motivation. Special thanks also go
to all of my friends for the additional information that really helps in
understanding this project well. Finally, I would like to give my
greatest honor to God who made all things possible.
...
In this project, we've tried to predict the popularity of Youtube videos
by developing a machine learning model based on a number of factors like
video category, upload time, duration, likes, dislikes, comments,
shares, video title , video thumbnail and views.

This project consists of three models:

In the first model, we've created a dataset of images, which are
classified as clickbait and not clickbait. Clickbait thumbnails are the
thumbnails which are eye-catching and often promote misleading
information. We've trained our model so that it can predict whether the
thumbnail uploaded by a Youtuber is clickbait or not.

In the second model, we've predicted the clickbaitness of the title
using various machine learning algorithms.

In the third model, we've analyzed past video performances and predicted
whether the newly uploaded video will be popular or not.

Signature of Student Signature of Supervisor Abhishek Pratap Singh\
1st May 2023
...
> **S.No:** **Page No.**
>
> 1\. Convolution Neural Network 27 2. Control Flow Diagram 28 3. Error
> Handling for Channel Not found error 37
...
Table 1 : Comparing R2, MSE , RMSE , MAE and MAPE 31 of different models
(Test Size=0.15)\
31 Table 2 : Comparing R2, MSE , RMSE , MAE and MAPE\
of different models (Test Size=0.20)\
Table 3 : Comparing R2, MSE , RMSE , MAE and MAPE 32 of different models
(Test Size=0.25)\
Table 4 : Risk Mitigation 34
